/**
 *
 * A demo of a minecraft world drawn by GPU shaders.
 *
 * 3D rendering is based on the shader at https://www.shadertoy.com/view/4ds3WS",
 *
 ...
 *
 * Change log:
 * - added Alife code for Dots wandering around the terrain
 * - added Brain (Neural Network) to the Dots
 * - modified shader to use the Red channel of the source map for altitude
 * - modified shader to tint voxels according to 'food' (the Green channel of the source map)
 * - modified shader to use the Alpha channel of the source map to show Dot creatures
 *
 */
...
function pbMineCraftDemo( docId )
{
	...
	this.camera.create( 0, 50, 0, -24, 38, -28 );
	...
	this.mapImg = pbPhaserRender.loader.loadImage( "image", "../img/australia.png" );
	...
	document.body.onkeypress = function( e )
	{
		...
		switch ( evt.keyCode )
		{
			case 43: // +
				...
				console.log( JSON.stringify( _this.alife ) );
				console.log( "----------------- copy to -------------------" );
				break;
		}
	};
